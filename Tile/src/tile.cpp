...
void Tile_t::SetOutlineColor(sf::Color outlineColor) { _shape.setOutlineColor(outlineColor); }
void Tile_t::SetPosition(sf::Vector2f position) { _shape.setPosition(position); }
void Tile_t::SetBorderWidth(float borderWidth) { _shape.setOutlineThickness(-borderWidth / 2.f); }
